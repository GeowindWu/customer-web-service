...
public class HttpRequest {
	 ...
	 */
	public static String sendGet_old(String url, String param) {
		String result = "";
	...
	public static String httpGet(String accessUrl){
		String result = null;
		...
		try {
			...
			if(response.getStatusLine().getStatusCode() == 200){
				...
				result = "异常码： " + response.getStatusLine().getStatusCode();
			}
	...
	public static String httpPost(String accessUrl, Map params) {
		...
		try {
			...
			InputStream content = entity.getContent();
			 ...
			 returnStr = IOUtils.toString(content,charSet);
